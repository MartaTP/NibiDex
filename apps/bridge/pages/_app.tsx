  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover NibiDex, the leading DEX on Nibiru Chain Chain (BSC) with the best farms in DeFi and a lottery for CAKE."
        />
        <meta name="theme-color" content="#6234b8" />
        <meta name="twitter:image" content="https://nibidex.com/images/hero.png" />
        <meta
        ...
        <meta name="twitter:title" content="🥞 NibiDex - A next evolution DeFi exchange on Nibiru Chain Chain (BSC)" />
        <title>Assets Swap Bridge</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
